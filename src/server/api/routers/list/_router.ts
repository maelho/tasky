...
export const listRouter = createTRPCRouter({
  ...
  getlistsWithCards: protectedProcedure.input(schema.ZGetlistsWithCards).query(handler.getlistsWithCards),
  updateListOrder: protectedProcedure.input(schema.ZUpdateListOrder).mutation(handler.updateListOrder),
  ...
  getListsByBoardId: protectedProcedure.input(schema.ZGetListsByBoardId).query(handler.getListsByBoardId),
})
