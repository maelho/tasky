...
export const cardRouter = createTRPCRouter({
  ...
  updateCardOrder: protectedProcedure.input(schema.ZUpdateCardOrder).mutation(handler.updateCardOrder),
  getCardById: protectedProcedure.input(schema.ZGetCardById).query(handler.getCardById),
  getCardsByListId: protectedProcedure.input(schema.ZGetCardsByListId).query(handler.getCardsByListId),
